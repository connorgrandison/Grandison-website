...
The site is public at the owner’s request. Supplied Facebook and Instagram profiles appear in the footer, contact page and business structured data. Website form delivery and phone/email remain to be configured. Update canonical, schema, sitemap and robots origins if a custom domain is chosen. Structured data describes business identity; it does not promise a Google rich result or AI citation.
